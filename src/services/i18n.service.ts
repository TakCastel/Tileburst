...
export interface Translations {
  ...
  landingPlayNow: string;
  landingDownloadIOS: string;
  landingDownloadAndroid: string;
  landingNote: string;
}
...
const TRANSLATIONS: Record<Language, Translations> = {
  fr: {
    ...
    shareScoreText: "J'ai fait {0} points sur Pavat ! Tu penses que tu peux me battre ? 🎮",
    shareScoreTitle: "J'ai fait {0} points sur Pavat !",
    ...
    landingTagline: 'Jeu de puzzle stratégique',
    landingDescription: 'Placez des tuiles sur une grille, formez des lignes et des groupes validés pour marquer des points. Défiez vos amis !',
    landingFeature1Title: 'Multi-plateforme',
    landingFeature1Desc: 'Jouez sur iOS, Android ou dans votre navigateur',
    landingFeature2Title: 'Stratégie',
    landingFeature2Desc: 'Planifiez vos coups et validez des groupes pour survivre',
    landingFeature3Title: 'Gratuit',
    landingFeature3Desc: 'Jouez gratuitement, sans publicité ni achat in-app',
    landingPlayNow: 'Jouer maintenant',
    landingDownloadIOS: 'Télécharger sur l\'App Store',
    landingDownloadAndroid: 'Télécharger sur Google Play',
    landingNote: 'Disponible également en mode hors ligne',
  },
  en: {
    score: 'Score',
    ...
    shareScoreText: "I scored {0} points on Pavat! Think you can beat me? 🎮",
    shareScoreTitle: "I scored {0} points on Pavat!",
    shareScoreCopied: 'Score copied to clipboard! You can now share it.',
    shareScoreCopyError: 'Copy this text to share your score:',
    tutorial: {
      welcome: {
        title: 'Welcome to Pavat!',
    ...
    landingTagline: 'Strategic puzzle game',
    landingDescription: 'Place tiles on a grid, form lines and validated groups to score points. Challenge your friends!',
    landingFeature1Title: 'Multi-platform',
    landingFeature1Desc: 'Play on iOS, Android or in your browser',
    landingFeature2Title: 'Strategic',
    landingFeature2Desc: 'Plan your moves and validate groups to survive',
    landingFeature3Title: 'Free',
    landingFeature3Desc: 'Play for free, no ads or in-app purchases',
    landingPlayNow: 'Play now',
    landingDownloadIOS: 'Download on App Store',
    landingDownloadAndroid: 'Download on Google Play',
    landingNote: 'Also available offline',
  },
  es: {
    score: 'Puntuación',
    ...
    shareScoreText: '¡Hice {0} puntos en Pavat! ¿Crees que puedes vencerme? 🎮',
    shareScoreTitle: '¡Hice {0} puntos en Pavat!',
    ...
    landingTagline: 'Juego de puzzle estratégico',
    landingDescription: 'Coloca fichas en una cuadrícula, forma líneas y grupos validados para ganar puntos. ¡Desafía a tus amigos!',
    landingFeature1Title: 'Multiplataforma',
    landingFeature1Desc: 'Juega en iOS, Android o en tu navegador',
    landingFeature2Title: 'Estratégico',
    landingFeature2Desc: 'Planifica tus movimientos y valida grupos para sobrevivir',
    landingFeature3Title: 'Gratis',
    landingFeature3Desc: 'Juega gratis, sin anuncios ni compras dentro de la app',
    landingPlayNow: 'Jugar ahora',
    landingDownloadIOS: 'Descargar en App Store',
    landingDownloadAndroid: 'Descargar en Google Play',
    landingNote: 'También disponible sin conexión',
  },
  de: {
    score: 'Punkte',
    ...
    shareScoreText: 'Ich habe {0} Punkte bei Pavat erreicht! Denkst du, du kannst mich schlagen? 🎮',
    shareScoreTitle: 'Ich habe {0} Punkte bei Pavat erreicht!',
    ...
    landingTagline: 'Strategisches Puzzle-Spiel',
    landingDescription: 'Platziere Kacheln auf einem Raster, bilde Linien und validierte Gruppen, um Punkte zu sammeln. Fordere deine Freunde heraus!',
    landingFeature1Title: 'Multiplattform',
    landingFeature1Desc: 'Spiele auf iOS, Android oder in deinem Browser',
    landingFeature2Title: 'Strategisch',
    landingFeature2Desc: 'Plane deine Züge und validiere Gruppen, um zu überleben',
    landingFeature3Title: 'Kostenlos',
    landingFeature3Desc: 'Spiele kostenlos, ohne Werbung oder In-App-Käufe',
    landingPlayNow: 'Jetzt spielen',
    landingDownloadIOS: 'Im App Store herunterladen',
    landingDownloadAndroid: 'Bei Google Play herunterladen',
    landingNote: 'Auch offline verfügbar',
  },
  it: {
    score: 'Punteggio',
    ...
    shareScoreText: 'Ho fatto {0} punti su Pavat! Pensi di poter battermi? 🎮',
    shareScoreTitle: 'Ho fatto {0} punti su Pavat!',
    ...
    landingTagline: 'Gioco di puzzle strategico',
    landingDescription: 'Posiziona le tessere su una griglia, forma linee e gruppi validati per ottenere punti. Sfida i tuoi amici!',
    landingFeature1Title: 'Multi-piattaforma',
    landingFeature1Desc: 'Gioca su iOS, Android o nel tuo browser',
    landingFeature2Title: 'Strategico',
    landingFeature2Desc: 'Pianifica le tue mosse e valida i gruppi per sopravvivere',
    landingFeature3Title: 'Gratuito',
    landingFeature3Desc: 'Gioca gratuitamente, senza pubblicità o acquisti in-app',
    landingPlayNow: 'Gioca ora',
    landingDownloadIOS: 'Scarica su App Store',
    landingDownloadAndroid: 'Scarica su Google Play',
    landingNote: 'Disponibile anche offline',
  },
  pt: {
    score: 'Pontuação',
    ...
    shareScoreText: 'Fiz {0} pontos no Pavat! Acha que consegue me vencer? 🎮',
    shareScoreTitle: 'Fiz {0} pontos no Pavat!',
    ...
    landingTagline: 'Jogo de quebra-cabeça estratégico',
    landingDescription: 'Coloque peças em uma grade, forme linhas e grupos validados para marcar pontos. Desafie seus amigos!',
    landingFeature1Title: 'Multiplataforma',
    landingFeature1Desc: 'Jogue no iOS, Android ou no seu navegador',
    landingFeature2Title: 'Estratégico',
    landingFeature2Desc: 'Planeje seus movimentos e valide grupos para sobreviver',
    landingFeature3Title: 'Gratuito',
    landingFeature3Desc: 'Jogue grátis, sem anúncios ou compras no aplicativo',
    landingPlayNow: 'Jogar agora',
    landingDownloadIOS: 'Baixar na App Store',
    landingDownloadAndroid: 'Baixar no Google Play',
    landingNote: 'Também disponível offline',
  },
  ru: {
    score: 'Счёт',
    ...
    shareScoreText: 'Я набрал {0} очков в Pavat! Думаешь, сможешь меня победить? 🎮',
    shareScoreTitle: 'Я набрал {0} очков в Pavat!',
    ...
    tutorial: {
      welcome: {
        title: 'Добро пожаловать в Pavat!',
    ...
    landingTagline: 'Стратегическая головоломка',
    landingDescription: 'Размещайте плитки на сетке, формируйте линии и проверенные группы, чтобы набирать очки. Бросьте вызов своим друзьям!',
    landingFeature1Title: 'Мультиплатформенный',
    landingFeature1Desc: 'Играйте на iOS, Android или в браузере',
    landingFeature2Title: 'Стратегический',
    landingFeature2Desc: 'Планируйте свои ходы и проверяйте группы, чтобы выжить',
    landingFeature3Title: 'Бесплатно',
    landingFeature3Desc: 'Играйте бесплатно, без рекламы и внутриигровых покупок',
    landingPlayNow: 'Играть сейчас',
    landingDownloadIOS: 'Скачать в App Store',
    landingDownloadAndroid: 'Скачать в Google Play',
    landingNote: 'Также доступно офлайн',
  },
  ja: {
    score: 'スコア',
    bestScore: 'ベストスコア',
    ...
    shareScoreText: 'Pavatで{0}ポイント獲得しました！勝てると思いますか？🎮',
    shareScoreTitle: 'Pavatで{0}ポイント獲得しました！',
    ...
    landingTagline: '戦略パズルゲーム',
    landingDescription: 'グリッドにタイルを配置し、ラインと検証済みグループを形成してポイントを獲得します。友達に挑戦しましょう！',
    landingFeature1Title: 'マルチプラットフォーム',
    landingFeature1Desc: 'iOS、Android、またはブラウザでプレイ',
    landingFeature2Title: '戦略的',
    landingFeature2Desc: '動きを計画し、グループを検証して生き残る',
    landingFeature3Title: '無料',
    landingFeature3Desc: '広告やアプリ内購入なしで無料プレイ',
    landingPlayNow: '今すぐプレイ',
    landingDownloadIOS: 'App Storeでダウンロード',
    landingDownloadAndroid: 'Google Playでダウンロード',
    landingNote: 'オフラインでも利用可能',
  },
  zh: {
    score: '分数',
    bestScore: '最佳分数',
    ...
    shareScoreText: '我在Pavat中获得了{0}分！你觉得你能打败我吗？🎮',
    shareScoreTitle: '我在Pavat中获得了{0}分！',
    ...
    landingTagline: '策略益智游戏',
    landingDescription: '在网格上放置方块，形成线条和已验证的组来得分。挑战你的朋友！',
    landingFeature1Title: '多平台',
    landingFeature1Desc: '在iOS、Android或浏览器中游戏',
    landingFeature2Title: '策略性',
    landingFeature2Desc: '规划你的行动并验证组以生存',
    landingFeature3Title: '免费',
    landingFeature3Desc: '免费游戏，无广告或应用内购买',
    landingPlayNow: '立即游戏',
    landingDownloadIOS: '在App Store下载',
    landingDownloadAndroid: '在Google Play下载',
    landingNote: '也可离线使用',
  },
  ko: {
    score: '점수',
    ...
    shareScoreText: 'Pavat에서 {0}점을 얻었습니다! 저를 이길 수 있다고 생각하시나요? 🎮',
    shareScoreTitle: 'Pavat에서 {0}점을 얻었습니다!',
    shareScoreCopied: '점수가 클립보드에 복사되었습니다! 이제 공유할 수 있습니다.',
    shareScoreCopyError: '점수를 공유하려면 이 텍스트를 복사하세요:',
    tutorial: {
      welcome: {
        title: 'Pavat에 오신 것을 환영합니다!',
    ...
    landingTagline: '전략 퍼즐 게임',
    landingDescription: '그리드에 타일을 배치하고, 선과 검증된 그룹을 형성하여 점수를 얻으세요. 친구들에게 도전하세요!',
    landingFeature1Title: '멀티 플랫폼',
    landingFeature1Desc: 'iOS, Android 또는 브라우저에서 플레이',
    landingFeature2Title: '전략적',
    landingFeature2Desc: '움직임을 계획하고 그룹을 검증하여 생존',
    landingFeature3Title: '무료',
    landingFeature3Desc: '광고나 인앱 구매 없이 무료 플레이',
    landingPlayNow: '지금 플레이',
    landingDownloadIOS: 'App Store에서 다운로드',
    landingDownloadAndroid: 'Google Play에서 다운로드',
    landingNote: '오프라인에서도 사용 가능',
  },
  nl: {
    score: 'Score',
    ...
    shareScoreText: 'Ik heb {0} punten gescoord op Pavat! Denk je dat je me kunt verslaan? 🎮',
    shareScoreTitle: 'Ik heb {0} punten gescoord op Pavat!',
    ...
    landingTagline: 'Strategisch puzzelspel',
    landingDescription: 'Plaats tegels op een rooster, vorm lijnen en gevalideerde groepen om punten te scoren. Daag je vrienden uit!',
    landingFeature1Title: 'Multiplatform',
    landingFeature1Desc: 'Speel op iOS, Android of in je browser',
    landingFeature2Title: 'Strategisch',
    landingFeature2Desc: 'Plan je zetten en valideer groepen om te overleven',
    landingFeature3Title: 'Gratis',
    landingFeature3Desc: 'Speel gratis, zonder advertenties of in-app aankopen',
    landingPlayNow: 'Nu spelen',
    landingDownloadIOS: 'Downloaden in App Store',
    landingDownloadAndroid: 'Downloaden in Google Play',
    landingNote: 'Ook offline beschikbaar',
  },
  pl: {
    score: 'Wynik',
    ...
    shareScoreText: 'Zdobyłem {0} punktów w Pavat! Myślisz, że możesz mnie pokonać? 🎮',
    shareScoreTitle: 'Zdobyłem {0} punktów w Pavat!',
    ...
    landingTagline: 'Strategiczna gra logiczna',
    landingDescription: 'Umieść płytki na siatce, tworz linie i zweryfikowane grupy, aby zdobywać punkty. Rzuć wyzwanie znajomym!',
    landingFeature1Title: 'Wieloplatformowa',
    landingFeature1Desc: 'Graj na iOS, Android lub w przeglądarce',
    landingFeature2Title: 'Strategiczna',
    landingFeature2Desc: 'Planuj ruchy i weryfikuj grupy, aby przetrwać',
    landingFeature3Title: 'Darmowa',
    landingFeature3Desc: 'Graj za darmo, bez reklam i zakupów w aplikacji',
    landingPlayNow: 'Graj teraz',
    landingDownloadIOS: 'Pobierz z App Store',
    landingDownloadAndroid: 'Pobierz z Google Play',
    landingNote: 'Dostępna również offline',
  },
  tr: {
    score: 'Skor',
    ...
    shareScoreText: 'Pavat\'ta {0} puan aldım! Beni yenebileceğini düşünüyor musun? 🎮',
    shareScoreTitle: 'Pavat\'ta {0} puan aldım!',
    ...
    landingTagline: 'Stratejik bulmaca oyunu',
    landingDescription: 'Bir ızgaraya karolar yerleştirin, çizgiler ve doğrulanmış gruplar oluşturarak puan kazanın. Arkadaşlarınıza meydan okuyun!',
    landingFeature1Title: 'Çoklu platform',
    landingFeature1Desc: 'iOS, Android veya tarayıcınızda oynayın',
    landingFeature2Title: 'Stratejik',
    landingFeature2Desc: 'Hareketlerinizi planlayın ve hayatta kalmak için grupları doğrulayın',
    landingFeature3Title: 'Ücretsiz',
    landingFeature3Desc: 'Reklam veya uygulama içi satın alma olmadan ücretsiz oynayın',
    landingPlayNow: 'Şimdi oyna',
    landingDownloadIOS: 'App Store\'dan indir',
    landingDownloadAndroid: 'Google Play\'den indir',
    landingNote: 'Çevrimdışı da mevcut',
  },
  ar: {
    score: 'النقاط',
    ...
    shareScoreText: 'حصلت على {0} نقطة في Pavat! هل تعتقد أنك تستطيع هزيمتي؟ 🎮',
    shareScoreTitle: 'حصلت على {0} نقطة في Pavat!',
    shareScoreCopied: 'تم نسخ النقاط إلى الحافظة! يمكنك الآن مشاركتها.',
    shareScoreCopyError: 'انسخ هذا النص لمشاركة نقاطك:',
    tutorial: {
      welcome: {
        title: 'مرحباً بك في Pavat!',
    ...
    landingTagline: 'لعبة ألغاز استراتيجية',
    landingDescription: 'ضع البلاط على الشبكة، وشكل الخطوط والمجموعات المصدقة لتسجيل النقاط. تحد أصدقاءك!',
    landingFeature1Title: 'متعدد المنصات',
    landingFeature1Desc: 'العب على iOS أو Android أو في متصفحك',
    landingFeature2Title: 'استراتيجي',
    landingFeature2Desc: 'خطط لحركاتك وتحقق من المجموعات للبقاء على قيد الحياة',
    landingFeature3Title: 'مجاني',
    landingFeature3Desc: 'العب مجانًا، بدون إعلانات أو مشتريات داخل التطبيق',
    landingPlayNow: 'العب الآن',
    landingDownloadIOS: 'تحميل من App Store',
    landingDownloadAndroid: 'تحميل من Google Play',
    landingNote: 'متاح أيضًا في وضع عدم الاتصال',
  },
};
